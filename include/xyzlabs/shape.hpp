...
struct Shape {
	...
	void draw() {
		...
		glBufferData(GL_ARRAY_BUFFER, sizeof(vertices), (void*)vertices.cbegin(), GL_STATIC_DRAW);

		glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, EBO);
		glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(indices), (void*)indices.cbegin(), GL_STATIC_DRAW);
